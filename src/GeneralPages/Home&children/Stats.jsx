...
const Stats = () => {
  return (
    <div className="flex flex-col items-center justify-center dark:bg-gray-700 dark:text-gray-100">
      <div className="w-full rounded">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 text-accent">
          ...
          {/* Experienced Tutors */}
          <motion.div 
            className="p-6 bg-white dark:bg-gray-700 dark:text-gray-100 rounded-lg shadow-md text-center border border-accent"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
          >
            <FaChalkboardTeacher className="text-4xl mb-2" />
            <h3 className="text-2xl dark:text-gray-100 font-bold">50,000+</h3>
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-100">Experienced Tutors</p>
          ...
          >
            ...
            <h3 className="text-2xl dark:text-gray-100 font-bold">300,000+</h3>
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-100">5-Star Reviews</p>
          ...
          >
            ...
            <h3 className="text-2xl dark:text-gray-100 font-bold">120+</h3>
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-100">Languages</p>
          ...
          >
            ...
            <h3 className="text-2xl dark:text-gray-100 font-bold">1,000,000+</h3>
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-100">Users</p>
